...
public class Room {
    ...
    public Room(String room_capacity, String room_name, String room_cost, String room_condition, String room_unic_code, String washroom_type, Boolean isSelected) {
